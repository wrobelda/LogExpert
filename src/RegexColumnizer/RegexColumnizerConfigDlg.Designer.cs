...
namespace RegexColumnizer
{
  partial class RegexColumnizerConfigDlg
  {
    ...
    {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RegexColumnizerConfigDlg));
        ...
        this.tabPage3.Controls.Add(this.fieldComboBox);
        this.tabPage3.Controls.Add(this.formatComboBox);
        this.tabPage3.Controls.Add(this.localTimeCheckBox);
